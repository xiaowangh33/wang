...
struct ControllerData{
    ...
    /** 与 RL 控制共用的策略实例；站立保持阶段可调用 WarmupObservationOnly 预热观测链 */
    std::shared_ptr<PolicyRunnerBase> policy_warmup_ptr;
    /** 站立阶段的目标关节位置，供 RL 切换时作为过渡起点，避免丢失 PD 误差力矩 */
    VecXf standup_goal_joint_pos;
};
